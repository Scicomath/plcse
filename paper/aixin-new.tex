...
\begin{document}
\title{Study on Chiral Magnetic Effect in Relativistic Heavy-ion Collisions}
...
\begin{abstract}
The magnetic field is a key ingredient for the Chiral Magnetic Effect (CME). We study the time evolution of the magnetic field in relativistic heavy ion collisions, considering the response of the QGP medium in the ideally conducting limit. It is observed that the magnetic field with the response of QGP medium will maintain a longer time than that of the magnetic field in a vacuum. And then we calculate the charge separation signal for RHIC and LHC energy region with different centrality to fit the experiment data. The result shows that our model is better at RHIC energy region, and not very well at LHC energy region. \\
...
Based on the theory of KMW~\cite{lab7}, we consider the magnetic field with the response of QGP medium to study the chiral charge separation effect. 
...
\section{The mechanism of chiral magnetic effect}
...
If all charged particles would be really emitted perpendicular to the reaction plane in which case $\phi=\pi/2$ or ¦Õ$\phi=3\pi/2$,
we will have
\begin{eqnarray}
Y_{\pm}=\Delta_{\pm}.
\label{eq:eq27} %Eq.27
...
\begin{eqnarray}
a_{++}=a_{--}=\frac{1}{N_{+}^{2}}\langle\Delta_{\pm}^{2}\rangle,
\label{eq:eq28} %Eq.28
\end{eqnarray}

\noindent and
\begin{eqnarray}
a_{+-}=a_{-+}=\frac{1}{N_{+}N_{-}}\langle\Delta_{+}\Delta_{-}\rangle,
\label{eq:eq29} %Eq.29
\end{eqnarray}
...
\caption{The dependencies of $a_{++}$($a_{--}$) on centralities for Au - Au collisions at $\sqrt{s_{NN}}$ = 200 GeV
of RHIC energy region, and for Pb - Pb collisions at $\sqrt{s_{NN}}$ = 2760 GeV of LHC energy region.}
\label{fig3} %Fig.3
\end{figure}

Refs.~\cite{lab30,lab31} published some  geometrical properties of the collision, such as the number of participating nucleons and the number of binary nucleon-nucleon collisions, which are deduced from a Glauber model with a sharp impact parameter selection and shown to be consistent with those extracted from the data of RHIC and LHC energy regions. Fig. 3 show the dependencies $a_{++}$($a_{--}$) of the chiral magnetic effect as a function of centrality, for Au - Au collisions at $\sqrt{s_{NN}}$ = 200 GeV of RHIC energy region, and for Pb - Pb collisions at $\sqrt{s_{NN}}$ = 2760 GeV of LHC energy region. In the calculation, the parameter $\chi$ is fixed by fitting the experiment data to minimize the sum of the squared errors(SSE). One find that $a_{++}$ increases with the increase of centralities. Our result for $a_{++}$ and $a_{+-}$ is displayed in Fig.3. Qualitatively the result agrees with the data presented in Ref.~\cite{lab8,lab9,lab10,lab11}.
...
% \caption{$\langle\Delta_{\pm}^{2}\rangle$(a) and $\langle\Delta_{+}\Delta_{-}\rangle/\langle\Delta_{\pm}^{2}\rangle$ (b) of the chiral magnetic effect as a function of centralities for different collision energies
% at $\sqrt{s_{NN}}$ = 62.4 GeV, 200GeV and 2760 GeV of RHIC and LHC energy regions for the screening length $\lambda/R$ = 0.2.}
% \label{fig7} %Fig.7
% \end{figure}

Fig.7(a) shows the dependencies of $\langle\Delta_{\pm}^{2}\rangle$ of the chiral magnetic effect as a function of centralities for different collision energies
at $\sqrt{s_{NN}}$ = 62.4 GeV, 200GeV and 2760 GeV of RHIC and LHC energy regions. It is found that $\langle\Delta_{\pm}^{2}\rangle$ is larger at LHC energy
region $\sqrt{s_{NN}}$ = 2760 GeV than that RHIC energy region $\sqrt{s_{NN}}$ = 62.4 GeV and 200GeV , and the $\langle\Delta_{\pm}^{2}\rangle$ is almost the same in the RHIC energy region.

Fig.7(b) shows the dependencies of $\langle\Delta_{+}\Delta_{-}\rangle/\langle\Delta_{\pm}^{2}\rangle$ of the chiral magnetic effect as a function of centralities for different collision energies
at $\sqrt{s_{NN}}$ = 62.4 GeV, 200GeV and 2760 GeV of RHIC and LHC energy regions. It is found that $\langle\Delta_{\pm}^{2}\rangle$ is slightly smaller at that $\sqrt{s_{NN}}$ = 2760 GeV of LHC
energy region than that of  $\sqrt{s_{NN}}$ = 62.4 GeV and 200GeV of RHIC energy region, and the $\langle\Delta_{+}\Delta_{-}\rangle/\langle\Delta_{\pm}^{2}\rangle$ at $\sqrt{s_{NN}}$ = 62.4 GeV and 200GeV in
