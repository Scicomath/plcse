...
The magnetic field can be given as£º
\begin{equation}
...
\label{eq:eq24} %Eq.24
\end{equation}
where $s,t=\pm$ denotes the charge sign, $\phi_{si}$
...
\label{eq:eq29} %Eq.29
\end{equation}
where $N_{\pm}$ denotes the total number of charged particles in the related $\eta$
interval.
