	...
	DATA JS/4,4,4/
       open(11,file='eB_b4fm_CMS.dat',status='old') 
        ...
        open(111,file='delta+-_b4fm_lambda0.1R-CMS1.dat',
     *      status='unknown')
          open(112,file='delta+-_b4fm_lambda0.2R-CMS1.dat',
     *      status='unknown')
        open(113,file='delta+-_b4fm_lambda0.3R-CMS1.dat',
     *      status='unknown')

       open(221,file='delta+-_b8fm_lambda0.1R-CMS1.dat',
     *      status='unknown')
          open(222,file='delta+-_b8fm_lambda0.2R-CMS1.dat',
     *      status='unknown')
        open(223,file='delta+-_b8fm_lambda0.3R-CMS1.dat',
     *      status='unknown')
