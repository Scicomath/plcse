...
# read theory data
Au6201 = genfromtxt('result/disklike/Au62GeV0.1.txt', delimiter=',')
Au6202 = genfromtxt('result/disklike/Au62GeV0.2.txt', delimiter=',')
Au6203 = genfromtxt('result/disklike/Au62GeV0.3.txt', delimiter=',')
Au20001 = genfromtxt('result/disklike/Au200GeV0.1.txt', delimiter=',')
Au20002 = genfromtxt('result/disklike/Au200GeV0.2.txt', delimiter=',')
Au20003 = genfromtxt('result/disklike/Au200GeV0.3.txt', delimiter=',')
Pb276001 = genfromtxt('result/disklike/Pb2760GeV0.1.txt', delimiter=',')
Pb276002 = genfromtxt('result/disklike/Pb2760GeV0.2.txt', delimiter=',')
Pb276003 = genfromtxt('result/disklike/Pb2760GeV0.3.txt', delimiter=',')
Cu6201 = genfromtxt('result/disklike/Cu62GeV0.1.txt', delimiter=',')
Cu6202 = genfromtxt('result/disklike/Cu62GeV0.2.txt', delimiter=',')
Cu6203 = genfromtxt('result/disklike/Cu62GeV0.3.txt', delimiter=',')
Cu20001 = genfromtxt('result/disklike/Cu200GeV0.1.txt', delimiter=',')
