	...
	DATA JS/4,4,4/
        ...
        open(111,file='delta-b4fm_lambda0.1R-CMS2.dat',
     *      status='unknown')
          open(112,file='delta-b4fm_lambda0.2R-CMS2.dat',
     *      status='unknown')
        open(113,file='delta-b4fm_lambda0.3R-CMS2.dat',
     *      status='unknown')

       open(221,file='delta-b8fm_lambda0.1R-CMS2.dat',
     *      status='unknown')
          open(222,file='delta-b8fm_lambda0.2R-CMS2.dat',
     *      status='unknown')
        open(223,file='delta-b8fm_lambda0.3R-CMS2.dat',
     *      status='unknown')
