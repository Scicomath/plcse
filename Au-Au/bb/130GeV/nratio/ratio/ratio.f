	...
	DOUBLE PRECISION x5,y5,x6,y6,x7,y7,x8,y8,x201,y201
       ...
       open(11,file='delta+-_130_lambda0.1R.dat',status='old')
       open(22,file='delta+-_130_lambda0.2R.dat',status='old')
       open(33,file='delta+-_130_lambda0.3R.dat',status='old')

       open(111,file='delta-130_lambda0.1R.dat',status='old')
       open(222,file='delta-130_lambda0.2R.dat',status='old')
       open(333,file='delta-130_lambda0.3R.dat',status='old')
