	...
	DATA JS/4,4,4/
        open(111,file='delta+-_200_lambda0.1R-bb1.dat',
     *      status='unknown')
        open(11,file='eB_200_bb.dat',status='old') 
        open(112,file='delta+-_200_lambda0.2R-bb1.dat',
     *      status='unknown')
        open(113,file='delta+-_200_lambda0.3R-bb1.dat',
     *      status='unknown')
