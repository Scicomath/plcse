	...
	DATA JS/4,4,4/
        open(21,file='delta+-_2760_lambda0.1R-bb2.dat',
     *     status='unknown')
        open(22,file='delta+-_2760_lambda0.2R-bb2.dat',
     *     status='unknown')
        open(23,file='delta+-_2760_lambda0.3R-bb2.dat',
     *     status='unknown')
...
**************************************************************************
     ...
     *       (x(3)*x(3)-ataui*ataui))
         f=-10.0*4.0*(25.0/81.0)*aksi*atau
